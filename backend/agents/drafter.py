...
from utils.llm_utils import strip_think, inject_verified_links
...
def draft_document_node(state: AgentState):
    ...
    content = inject_verified_links(content)
    import re
...
❌ Jokes, stories, poems, songs, games, and entertainment requests
